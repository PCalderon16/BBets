...
sd(Substitute)
```
Using the mean and standard deviation (subtracting 110 from the mean and adding 110 to the mean) we found the interval we're looking for, and it looks like the profit is centered around zero. If the profit is centered around zero, that is fair odds. More specifically, the fair odds is when Brownlow would wager 4.38 dollars for every 1 dollar the students would wager. 
